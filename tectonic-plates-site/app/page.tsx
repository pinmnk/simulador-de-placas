            ...
            <CardContent>
              ...
              <div className="flex flex-wrap gap-4 justify-center">
                ...
                <Button
                  ...
                  className={`flex-1 min-w-[200px] ${
                    activeAnimation === "transform"
                      ? "bg-gradient-to-r from-yellow-600 to-amber-600 hover:from-yellow-700 hover:to-amber-700 text-white border-0"
            ...
            <Card className="border-l-4 border-l-red-500">
              ...
              <CardContent className="space-y-6">
                <div className="grid md:grid-cols-2 gap-6">
                  <div>
                    <img
                      src="/images/design-mode/Imagem%20do%20WhatsApp%20de%202025-10-27%20%C3%A0%28s%29%2020.08.04_789d7349.jpg"
                      alt="Movimento Convergente - Limite Convergente"
            ...
            <Card className="border-l-4 border-l-blue-500">
              ...
              <CardContent className="space-y-6">
                <div className="grid md:grid-cols-2 gap-6">
                  <div>
                    <img
                      src="/images/design-mode/Imagem%20do%20WhatsApp%20de%202025-10-27%20%C3%A0%28s%29%2020.08.03_64dad4fd.jpg"
                      alt="Movimento Divergente - Limite Divergente"
                      className="w-full h-48 object-contain rounded-lg bg-white"
                    />
                  </div>
                  <div className="space-y-4">
            ...
            <Card className="border-l-4 border-l-yellow-500">
              ...
              <CardContent className="space-y-6">
                <div className="grid md:grid-cols-2 gap-6">
                  <div>
                    <img
                      src="/images/design-mode/Imagem%20do%20WhatsApp%20de%202025-10-27%20%C3%A0%28s%29%2020.08.04_9d0cd2f0.jpg"
                      alt="Movimento Transformante - Limite Transformante"
                      className="w-full h-48 object-contain rounded-lg bg-white"
                    />
                  </div>
                  <div className="space-y-4">
